...
function ServiceVisual({ service }: { service: Service }) {
  return (
    <div className="border-line bg-ink-900 relative aspect-[4/3] overflow-hidden rounded-xl border lg:aspect-[4/5]">
        ...
        >
          ...
          <ul className="mt-5 flex flex-col">
            {service.focus.map((item) => (
              ...
              >
                <span className="bg-gold-500 h-px w-5 shrink-0" aria-hidden="true" />
                {item}
              </li>
            ))}
          </ul>
